SELECT
    ...
    sys_get_userbyid(datdba) AS datowner, datcollate, datctype, datconnlimit,
    ...
    (SELECT array_agg(provider || '=' || label) FROM sys_shseclabel sl1 WHERE sl1.objoid=db.oid) AS seclabels,
