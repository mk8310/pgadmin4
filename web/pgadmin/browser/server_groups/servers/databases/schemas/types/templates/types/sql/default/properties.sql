SELECT t.oid, t.typname AS name,
    ...
    sys_get_userbyid(t.typowner) as typeowner, e.typname as element,
    description, ct.oid AS taboid,
    nsp.nspname AS schema,
    --MinimumVersion 9.1 START
    (SELECT array_agg(provider || '=' || label) FROM sys_seclabel sl1 WHERE sl1.objoid=t.oid) AS seclabels,
    -- END
