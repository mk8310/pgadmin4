...
FROM sys_attribute att
    ...
    LEFT OUTER JOIN sys_collation c ON att.attcollation=c.oid
    LEFT OUTER JOIN sys_namespace nspc ON c.collnamespace=nspc.oid
...
FROM sys_range
    ...
    LEFT JOIN sys_collation col ON col.oid=rngcollation
